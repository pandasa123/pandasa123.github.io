			...
			>
				...
				<div className={'p-6 flex-1 flex flex-col justify-between'}>
					...
					<p className={'inline-flex items-center'}>
						...
						>
							<path
								d="M14 3.41l-7.3 7.3a1 1 0 0 1-1.4-1.42L12.58 2H9a1 1 0 1 1 0-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V3.41zM12 11a1 1 0 0 1 2 0v3a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h3a1 1 0 1 1 0 2H2v10h10v-3z"></path>
						</svg>
					</p>
				</div>
			</AniLink>
